...
func (r *RoleRepository) Create(ctx interface{}, roleEntity *role.Role) error {
...
func (r *RoleRepository) GetByID(ctx interface{}, id string) (*role.Role, error) {
	context := ctx.(context.Context)
...
func (r *RoleRepository) GetByName(ctx interface{}, name string) (*role.Role, error) {
	context := ctx.(context.Context)
...
func (r *RoleRepository) Update(ctx interface{}, roleEntity *role.Role) error {
	context := ctx.(context.Context)
...
func (r *RoleRepository) List(ctx interface{}) ([]*role.Role, error) {
	context := ctx.(context.Context)
