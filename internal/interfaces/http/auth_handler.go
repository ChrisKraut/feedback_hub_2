...
func NewAuthHandler(userService *application.UserService, roleService *application.RoleService, jwtService *auth.JWTService, passwordService *auth.PasswordService) *AuthHandler {
	return &AuthHandler{
...
func (h *AuthHandler) Login(w http.ResponseWriter, r *http.Request) {
	...
	if user.PasswordHash == "" {
		writeErrorResponse(w, http.StatusUnauthorized, "Password login not available for this account")
		return
	}
	...
	if err != nil {
		writeErrorResponse(w, http.StatusInternalServerError, "Failed to get user role")
		return
	}
...
func (h *AuthHandler) Register(w http.ResponseWriter, r *http.Request) {
	...
	if req.Email == "" || req.Name == "" || req.Password == "" {
		writeErrorResponse(w, http.StatusBadRequest, "Email, name, and password are required")
		return
	}
	...
	if err != nil {
		writeErrorResponse(w, http.StatusInternalServerError, "Failed to get default role")
		return
	}
